...
var IGNORE_SELF = (process.env["IGNORE_SELF"] || "true") === "true";
var REQUIRE_MENTION = (process.env["REQUIRE_MENTION"] || "true") === "true";
var ONLY_CONTENT = (process.env["ONLY_CONTENT"] || "false") === "true";
